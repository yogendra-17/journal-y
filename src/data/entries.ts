...
And honestly, that's probably the best compliment you can give an abstraction.`,
  ...
  },
  {
    ...
    content: `I've been thinking about how weird it is that talking to an LLM feels like talking to a person. Not because of what it says—though that's impressive too—but because of *how* it says it. The response doesn't just appear. It *flows*. Token by token, word by word, like someone's actually typing on the other end.
